               ...
               <template v-if="role === 'super_admin'">
                    ...
                    <div style="margin-top: 20px;background-color: white; width: 100%;">
                         ...
                         <v-window v-model="activeMainTab">
                              ...
                              <v-window-item value="draft_events">
                                   <DraftEvents />
                              </v-window-item>
...
import DraftEvents from "../components/DraftEvents.vue";
import MembershipRevenue from "../components/MembershipRevenue.vue";
import OrganizationsReport from "../components/OrganizationsReport.vue";

const role = localStorage.getItem("role") || "admin";
const activeMainTab = ref("organizations"); // default tab
